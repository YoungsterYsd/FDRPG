...
namespace RPGGameplayTags
{
	...
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_NormalAttack);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Skill1);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Skill2);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Skill3);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Skill4);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Ultimate);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MouseLeftClick);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MouseRightClick);
	RPGGAME_API	UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_MouseMove);
