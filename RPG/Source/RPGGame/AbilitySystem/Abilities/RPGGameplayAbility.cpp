...
URPGHeroComponent* URPGGameplayAbility::GetHeroComponentFromActorInfo() const
{
	return (CurrentActorInfo ? URPGHeroComponent::FindHeroComponent(CurrentActorInfo->AvatarActor.Get()) : nullptr);
}
...
void URPGGameplayAbility::SetCameraMode(TSubclassOf<URPGCameraMode> CameraMode)
{
	...
	if (URPGHeroComponent* HeroComponent = GetHeroComponentFromActorInfo())
	{
