...
#include "RPGGamePhaseAbility.generated.h"
...
class URPGGamePhaseAbility : public URPGGameplayAbility
{
	GENERATED_BODY()

public:

	URPGGamePhaseAbility(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "RPG|Game Phase")
