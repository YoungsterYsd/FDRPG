...
#include "RPGAudioMixEffectsSubsystem.generated.h"
...
USTRUCT()
struct FRPGAudioSubmixEffectsChain
{
	GENERATED_BODY()
 ...
 */
UCLASS(MinimalAPI)
class URPGAudioMixEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(Transient)
	TArray<FRPGAudioSubmixEffectsChain> HDRSubmixEffectChain;

	// Submix Effect hain Overrides to apply when HDR Audio is turned off
	UPROPERTY(Transient)
	TArray<FRPGAudioSubmixEffectsChain> LDRSubmixEffectChain;
