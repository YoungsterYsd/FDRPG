...
RPGGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);
...
class URPGCharacterMovementComponent : public UCharacterMovementComponent
{
	GENERATED_BODY()

public:

	UE_API URPGCharacterMovementComponent(const FObjectInitializer& ObjectInitializer);
	...
	UE_API const FRPGCharacterGroundInfo& GetGroundInfo();
