 ...
 */
UCLASS(MinimalAPI)
class URPGPawnExtensionComponent : public UPawnComponent, public IGameFrameworkInitStateInterface
{
	GENERATED_BODY()

public:

	UE_API URPGPawnExtensionComponent(const FObjectInitializer& ObjectInitializer);
	...
	UE_API void InitializeAbilitySystem(URPGAbilitySystemComponent* InASC, AActor* InOwnerActor);
