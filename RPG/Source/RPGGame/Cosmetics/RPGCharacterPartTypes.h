...
#include "RPGCharacterPartTypes.generated.h"
...
struct FRPGCharacterPartHandle
{
	GENERATED_BODY()
...
struct FRPGCharacterPart
{
	...
	static bool AreEquivalentParts(const FRPGCharacterPart& A, const FRPGCharacterPart& B)
	{
