...
#include "RPGCosmeticAnimationTypes.generated.h"
...
struct FRPGAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FRPGAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FRPGAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FRPGAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FRPGAnimBodyStyleSelectionSet
{
	GENERATED_BODY()
		
	// List of layer rules to apply, first one that matches will be used
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta=(TitleProperty=Mesh))
	TArray<FRPGAnimBodyStyleSelectionEntry> MeshRules;
