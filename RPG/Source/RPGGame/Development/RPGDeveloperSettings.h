...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=RPG, meta=(AllowedTypes="RPGExperienceDefinition"))
	FPrimaryAssetId ExperienceOverride;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=RPGBots, meta=(InlineEditConditionToggle))
	bool bOverrideBotCount = false;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=RPGBots, meta=(EditCondition=bOverrideBotCount))
	int32 OverrideNumPlayerBotsToSpawn = 0;

	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=RPGBots)
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, config, Category=RPG)
	...
	*/
	UPROPERTY(config, EditAnywhere, Category = RPG, meta = (ConsoleVariable = "LyraPC.ShouldAlwaysPlayForceFeedback"))
	...
	UPROPERTY(config, EditAnywhere, Category=RPG)
	TArray<FRPGCheatToRun> CheatsToRun;
...
public:
	...
	RPGGAME_API void OnPlayInEditorStarted() const;
