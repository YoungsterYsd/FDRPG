...
#include "AnimNotify_RPGContextEffects.generated.h"
...
struct FRPGContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FRPGContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FRPGContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct FRPGContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/RPGGame.RPGContextEffectsLibrary"))
...
class UAnimNotify_RPGContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UE_API UAnimNotify_RPGContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FRPGContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FRPGContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FRPGContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FRPGContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
