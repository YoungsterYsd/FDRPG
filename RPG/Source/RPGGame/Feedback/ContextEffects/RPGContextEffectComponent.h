...
#include "RPGContextEffectComponent.generated.h"
...
class URPGContextEffectComponent : public UActorComponent, public IRPGContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UE_API URPGContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<URPGContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	UE_API void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	UE_API void UpdateLibraries(TSet<TSoftObjectPtr<URPGContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<URPGContextEffectsLibrary>> CurrentContextEffectsLibraries;
