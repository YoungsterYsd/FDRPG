...
#include "RPGContextEffectsLibrary.generated.h"
 ...
 */
UCLASS(MinimalAPI)
class URPGActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
DECLARE_DYNAMIC_DELEGATE_OneParam(FRPGContextEffectLibraryLoadingComplete, TArray<URPGActiveContextEffects*>, RPGActiveContextEffects);

/**
 * 
 */
UCLASS(MinimalAPI, BlueprintType)
class URPGContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TArray<FRPGContextEffects> ContextEffects;
...
private:
	...
	void RPGContextEffectLibraryLoadingComplete(TArray<URPGActiveContextEffects*> RPGActiveContextEffects);

	UPROPERTY(Transient)
	TArray< TObjectPtr<URPGActiveContextEffects>> ActiveContextEffects;
