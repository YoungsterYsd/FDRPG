...
#include "RPGNumberPopComponent_MeshText.h"

#include "Components/StaticMeshComponent.h"
#include "Engine/CollisionProfile.h"
#include "Engine/Engine.h"
#include "Engine/World.h"
#include "Feedback/NumberPops/RPGNumberPopComponent.h"
#include "RPGDamagePopStyle.h"
#include "Materials/MaterialInstanceDynamic.h"
#include "TimerManager.h"
#include "UObject/Package.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGNumberPopComponent_MeshText)

class UStaticMesh;

URPGNumberPopComponent_MeshText::URPGNumberPopComponent_MeshText(const FObjectInitializer& ObjectInitializer)
...
void URPGNumberPopComponent_MeshText::AddNumberPop(const FRPGNumberPopRequest& NewRequest)
{
...
void URPGNumberPopComponent_MeshText::ReleaseNextComponents()
{
	UWorld* LocalWorld = GetWorld();
	check(LocalWorld);
...
FLinearColor URPGNumberPopComponent_MeshText::DetermineColor(const FRPGNumberPopRequest& Request) const
{
	for (URPGDamagePopStyle* Style : Styles)
	{
...
UStaticMesh* URPGNumberPopComponent_MeshText::DetermineStaticMesh(const FRPGNumberPopRequest& Request) const
{
	for (URPGDamagePopStyle* Style : Styles)
	{
...
void URPGNumberPopComponent_MeshText::SetMaterialParameters(const FRPGNumberPopRequest& Request, FTempNumberPopInfo& NewDamageNumberInfo, const FTransform& CameraTransform, const FVector& NumberLocation)
{
