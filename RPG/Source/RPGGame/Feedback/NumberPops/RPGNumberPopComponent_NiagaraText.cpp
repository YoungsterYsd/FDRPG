...
#include "RPGNumberPopComponent_NiagaraText.h"

#include "Feedback/NumberPops/RPGNumberPopComponent.h"
#include "RPGDamagePopStyleNiagara.h"
#include "RPGLogChannels.h"
#include "NiagaraComponent.h"
#include "NiagaraDataInterfaceArrayFunctionLibrary.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGNumberPopComponent_NiagaraText)

URPGNumberPopComponent_NiagaraText::URPGNumberPopComponent_NiagaraText(const FObjectInitializer& ObjectInitializer)
...
void URPGNumberPopComponent_NiagaraText::AddNumberPop(const FRPGNumberPopRequest& NewRequest)
{
