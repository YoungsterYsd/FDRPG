...
class URPGGameFeaturePolicy : public UDefaultGameFeaturesProjectPolicies
{
	GENERATED_BODY()

public:
	RPGGAME_API static URPGGameFeaturePolicy& Get();
...
// URPGGameFeature_HotfixManager 已裁剪（C3 Hotfix/ 移除）
