...
#include "RPGBotCreationComponent.generated.h"
...
class URPGBotCreationComponent : public UGameStateComponent
{
	GENERATED_BODY()

public:
	URPGBotCreationComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
