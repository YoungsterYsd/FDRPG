...
#include "RPGUserFacingExperienceDefinition.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGUserFacingExperienceDefinition)

UCommonSession_HostSessionRequest* URPGUserFacingExperienceDefinition::CreateHostingRequest(const UObject* WorldContextObject) const
{
	...
	// Replay 已裁剪（C1），bRecordReplay 字段保留但不生效
