...
#include "RPGInputModifiers.generated.h"

struct FInputActionValue;

class FProperty;
class UEnhancedPlayerInput;
class URPGAimSensitivityData;
class UObject;
...
class URPGSettingBasedScalar : public UInputModifier
{
	GENERATED_BODY()
 ...
 */
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "RPG Settings Driven Dead Zone"))
class URPGInputModifierDeadZone : public UInputModifier
{
	GENERATED_BODY()
...
UENUM()
enum class ERPGTargetingType : uint8
{
...
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "RPG Gamepad Sensitivity"))
class URPGInputModifierGamepadSensitivity : public UInputModifier
{
	GENERATED_BODY()
public:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadWrite, Category=Settings, Config)
	ERPGTargetingType TargetingType = ERPGTargetingType::Normal;

	/** Asset that gives us access to the float scalar value being used for sensitivty */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta=(AssetBundles="Client,Server"))
	TObjectPtr<const URPGAimSensitivityData> SensitivityLevelTable;
...
UCLASS(NotBlueprintable, MinimalAPI, meta = (DisplayName = "RPG Aim Inversion Setting"))
class URPGInputModifierAimInversion : public UInputModifier
{
	GENERATED_BODY()
