...
#include "RPGPlayerInput.h"
#include "Performance/LatencyMarkerModule.h"
#include "Settings/RPGSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGPlayerInput)

URPGPlayerInput::URPGPlayerInput()
	: Super()
{
...
bool URPGPlayerInput::InputKey(const FInputKeyEventArgs& Params)
{
...
void URPGPlayerInput::ProcessInputEventForLatencyMarker(const FInputKeyEventArgs& Params)
{
...
void URPGPlayerInput::BindToLatencyMarkerSettingChange()
{
...
void URPGPlayerInput::UnbindLatencyMarkerSettingChangeListener()
{
	URPGSettingsLocal* Settings = URPGSettingsLocal::Get();
	if (!Settings)
	{
...
void URPGPlayerInput::HandleLatencyMarkerSettingChanged()
{
	// Make sure that we only ever get this callback on platforms which support latency markers
	ensure(URPGSettingsLocal::DoesPlatformSupportLatencyMarkers());
