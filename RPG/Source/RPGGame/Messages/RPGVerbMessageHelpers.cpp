...
#include "RPGVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGVerbMessageHelpers)
...
FString FRPGVerbMessage::ToString() const
{
	...
	FRPGVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* URPGVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* URPGVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters URPGVerbMessageHelpers::VerbMessageToCueParameters(const FRPGVerbMessage& Message)
{
...
FRPGVerbMessage URPGVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FRPGVerbMessage Result;
