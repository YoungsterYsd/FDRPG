...
DECLARE_LOG_CATEGORY_EXTERN(LogRPGCheat, Log, All);
...
class URPGCheatManager : public UCheatManager
{
	GENERATED_BODY()
...
protected:
	...
	void ApplySetByCallerDamage(URPGAbilitySystemComponent* RPGASC, float DamageAmount);
	void ApplySetByCallerHeal(URPGAbilitySystemComponent* RPGASC, float HealAmount);

	URPGAbilitySystemComponent* GetPlayerAbilitySystemComponent() const;
};
