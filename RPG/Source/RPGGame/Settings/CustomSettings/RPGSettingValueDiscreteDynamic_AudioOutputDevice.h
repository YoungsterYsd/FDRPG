...
#include "RPGSettingValueDiscreteDynamic_AudioOutputDevice.generated.h"
...
UCLASS()
class URPGSettingValueDiscreteDynamic_AudioOutputDevice : public UGameSettingValueDiscreteDynamic
{
	GENERATED_BODY()
	
public:

	virtual ~URPGSettingValueDiscreteDynamic_AudioOutputDevice() = default;
