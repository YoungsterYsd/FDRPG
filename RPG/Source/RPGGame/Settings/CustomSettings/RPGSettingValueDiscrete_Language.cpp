...
#include "RPGSettingValueDiscrete_Language.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGSettingValueDiscrete_Language)

#define LOCTEXT_NAMESPACE "Lyra"

static const int32 SettingSystemDefaultLanguageIndex = 0;

URPGSettingValueDiscrete_Language::URPGSettingValueDiscrete_Language()
{
}

void URPGSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void URPGSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void URPGSettingValueDiscrete_Language::OnApply()
{
...
void URPGSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void URPGSettingValueDiscrete_Language::RestoreToInitial()
{
	if (URPGSettingsShared* Settings = CastChecked<URPGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void URPGSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (URPGSettingsShared* Settings = CastChecked<URPGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 URPGSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const URPGSettingsShared* Settings = CastChecked<URPGLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> URPGSettingValueDiscrete_Language::GetDiscreteOptions() const
{
