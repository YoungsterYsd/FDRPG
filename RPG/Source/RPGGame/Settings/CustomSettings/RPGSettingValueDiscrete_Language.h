...
#include "RPGSettingValueDiscrete_Language.generated.h"
...
UCLASS(MinimalAPI)
class URPGSettingValueDiscrete_Language : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	UE_API URPGSettingValueDiscrete_Language();
