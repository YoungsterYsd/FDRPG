...
#include "RPGSettingValueDiscrete_MobileFPSType.generated.h"
...
UCLASS()
class URPGSettingValueDiscrete_MobileFPSType : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	URPGSettingValueDiscrete_MobileFPSType();
