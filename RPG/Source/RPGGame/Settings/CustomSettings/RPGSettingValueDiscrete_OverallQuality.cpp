...
#include "RPGSettingValueDiscrete_OverallQuality.h"

#include "Engine/Engine.h"
#include "Settings/RPGSettingsLocal.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGSettingValueDiscrete_OverallQuality)

#define LOCTEXT_NAMESPACE "LyraSettings"

URPGSettingValueDiscrete_OverallQuality::URPGSettingValueDiscrete_OverallQuality()
{
}

void URPGSettingValueDiscrete_OverallQuality::OnInitialized()
{
	Super::OnInitialized();
...
void URPGSettingValueDiscrete_OverallQuality::StoreInitial()
{
}

void URPGSettingValueDiscrete_OverallQuality::ResetToDefault()
{
}

void URPGSettingValueDiscrete_OverallQuality::RestoreToInitial()
{
}

void URPGSettingValueDiscrete_OverallQuality::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 URPGSettingValueDiscrete_OverallQuality::GetDiscreteOptionIndex() const
{
...
TArray<FText> URPGSettingValueDiscrete_OverallQuality::GetDiscreteOptions() const
{
	const int32 OverallQualityLevel = GetOverallQualityLevel();
	if (OverallQualityLevel == INDEX_NONE)
	{
...
int32 URPGSettingValueDiscrete_OverallQuality::GetCustomOptionIndex() const
{
	return OptionsWithCustom.Num() - 1;
}

int32 URPGSettingValueDiscrete_OverallQuality::GetOverallQualityLevel() const
{
