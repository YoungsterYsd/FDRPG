...
#include "RPGSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "LyraSettings"

URPGSettingValueDiscrete_Resolution::URPGSettingValueDiscrete_Resolution()
{
}

void URPGSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void URPGSettingValueDiscrete_Resolution::StoreInitial()
{
	// Ignored
}

void URPGSettingValueDiscrete_Resolution::ResetToDefault()
{
	// Ignored
}

void URPGSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// Ignored
}

void URPGSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 URPGSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> URPGSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void URPGSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void URPGSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void URPGSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool URPGSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 URPGSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 URPGSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 URPGSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void URPGSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText URPGSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
