...
#include "RPGSettingValueDiscrete_Resolution.generated.h"
...
UCLASS()
class URPGSettingValueDiscrete_Resolution : public UGameSettingValueDiscrete
{
	GENERATED_BODY()
	
public:

	URPGSettingValueDiscrete_Resolution();
