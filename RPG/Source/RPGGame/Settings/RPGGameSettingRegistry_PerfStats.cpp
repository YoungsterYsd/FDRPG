...
#include "CustomSettings/RPGSettingValueDiscrete_PerfStat.h"
...
static TAutoConsoleVariable<bool> CVarLatencyMarkersRequireNVIDIA(TEXT("RPG.Settings.LatencyMarkersRequireNVIDIA"),
	true,
...
public:
	...
	{
		if (!URPGSettingsLocal::DoesPlatformSupportLatencyTrackingStats())
		{
...
public:
	...
	virtual void GatherEditState(const ULocalPlayer * InLocalPlayer, FGameSettingEditableState & InOutEditState) const override
	{
		if (!URPGSettingsLocal::DoesPlatformSupportLatencyMarkers())
		{
...
void URPGGameSettingRegistry::AddPerformanceStatPage(UGameSettingCollection* PerfStatsOuterCategory, URPGLocalPlayer* InLocalPlayer)
{
	//----------------------------------------------------------------------------------
	{
		static_assert((int32)ERPGDisplayablePerformanceStat::Count == 18, "Consider updating this function to deal with new performance stats");
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::ClientFPS);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::ServerFPS);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::FrameTime);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::IdleTime);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::FrameTime_GameThread);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::FrameTime_RenderThread);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::FrameTime_RHIThread);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::FrameTime_GPU);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::Ping);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketLoss_Incoming);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketLoss_Outgoing);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketRate_Incoming);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketRate_Outgoing);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketSize_Incoming);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::PacketSize_Outgoing);
		...
		////////////////////////////////////////////////////////////////////////////////////
		{
			...
			//----------------------------------------------------------------------------------
			{
				...
				Setting->SetDefaultValue(URPGSettingsLocal::DoesPlatformSupportLatencyTrackingStats());
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::Latency_Total);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::Latency_Game);
			...
			{
				URPGSettingValueDiscrete_PerfStat* Setting = NewObject<URPGSettingValueDiscrete_PerfStat>();
				Setting->SetStat(ERPGDisplayablePerformanceStat::Latency_Render);
