...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGBrightnessEditor)
...
URPGBrightnessEditor::URPGBrightnessEditor(const FObjectInitializer& Initializer)
	: Super(Initializer)
{
...
void URPGBrightnessEditor::NativeOnInitialized()
{
	Super::NativeOnInitialized();
	Switcher_SafeZoneMessage->SetActiveWidget(RichText_Default);
}

void URPGBrightnessEditor::NativeOnActivated()
{
...
bool URPGBrightnessEditor::ExecuteActionForSetting_Implementation(FGameplayTag ActionTag, UGameSetting* InSetting)
{
...
FReply URPGBrightnessEditor::NativeOnAnalogValueChanged(const FGeometry& InGeometry, const FAnalogInputEvent& InAnalogEvent)
{
...
FReply URPGBrightnessEditor::NativeOnMouseWheel(const FGeometry& InGeometry, const FPointerEvent& InMouseEvent)
{
...
void URPGBrightnessEditor::HandleInputModeChanged(ECommonInputType InInputType)
{
...
void URPGBrightnessEditor::HandleBackClicked()
{
	DeactivateWidget();
	SSafeZone::SetGlobalSafeZoneScale(URPGSettingsLocal::Get()->GetSafeZone());
}

void URPGBrightnessEditor::HandleDoneClicked()
{
