...
#include "RPGBrightnessEditor.generated.h"
...
UCLASS(Abstract)
class URPGBrightnessEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	URPGBrightnessEditor(const FObjectInitializer& Initializer);
