...
#include "RPGSafeZoneEditor.generated.h"
...
UCLASS(Abstract)
class URPGSafeZoneEditor : public UCommonActivatableWidget, public IGameSettingActionInterface
{
	GENERATED_BODY()
...
public:
	URPGSafeZoneEditor(const FObjectInitializer& Initializer);
