...
#include "RPGSettingsListEntrySetting_KeyboardInput.generated.h"

class UKeyAlreadyBoundWarning;

class UGameSetting;
class UGameSettingPressAnyKey;
class URPGButtonBase;
class URPGSettingKeyboardInput;
class UObject;
...
class URPGSettingsListEntrySetting_KeyboardInput : public UGameSettingListEntry_Setting
{
	GENERATED_BODY()
...
protected:
	UPROPERTY()
	TObjectPtr<URPGSettingKeyboardInput> KeyboardInputSetting;
...
private:	// Bound Widgets
	...
	TObjectPtr<URPGButtonBase> Button_PrimaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<URPGButtonBase> Button_SecondaryKey;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<URPGButtonBase> Button_Clear;

	UPROPERTY(BlueprintReadOnly, meta = (BindWidget, BlueprintProtected = true, AllowPrivateAccess = true))
	TObjectPtr<URPGButtonBase> Button_ResetToDefault;
};
