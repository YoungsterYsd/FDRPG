...
#include "RPGActorUtilities.h"

#include "GameFramework/Actor.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGActorUtilities)

EBlueprintExposedNetMode URPGActorUtilities::SwitchOnNetMode(const UObject* WorldContextObject)
{
