...
#include "RPGActorUtilities.generated.h"
...
UCLASS()
class URPGActorUtilities : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "RPG", meta=(WorldContext="WorldContextObject", ExpandEnumAsExecs=ReturnValue))
