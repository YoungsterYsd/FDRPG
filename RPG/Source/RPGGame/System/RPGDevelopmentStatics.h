...
#include "RPGDevelopmentStatics.generated.h"
...
UCLASS()
class URPGDevelopmentStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "RPG", meta=(ExpandBoolAsExecs="ReturnValue"))
