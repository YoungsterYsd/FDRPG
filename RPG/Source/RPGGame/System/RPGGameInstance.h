...
class URPGGameInstance : public UCommonGameInstance
{
	GENERATED_BODY()

public:

	UE_API URPGGameInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());

	UE_API ARPGPlayerController* GetPrimaryPlayerController() const;
