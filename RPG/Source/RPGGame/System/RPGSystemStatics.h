...
#include "RPGSystemStatics.generated.h"
...
UCLASS()
class URPGSystemStatics : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "RPG", meta = (WorldContext = "WorldContextObject"))
