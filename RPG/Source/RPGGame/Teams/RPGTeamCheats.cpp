...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGTeamCheats)

//////////////////////////////////////////////////////////////////////
// ULyraTeamCheats

void URPGTeamCheats::CycleTeam()
{
	if (URPGTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<URPGTeamSubsystem>(GetWorld()))
	{
...
void URPGTeamCheats::SetTeam(int32 TeamID)
{
	if (URPGTeamSubsystem* TeamSubsystem = UWorld::GetSubsystem<URPGTeamSubsystem>(GetWorld()))
	{
