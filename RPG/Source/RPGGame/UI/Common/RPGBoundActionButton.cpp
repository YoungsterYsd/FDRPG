...
#include "RPGBoundActionButton.h"

#include "CommonInputSubsystem.h"
#include "CommonInputTypeEnum.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGBoundActionButton)

class UCommonButtonStyle;

void URPGBoundActionButton::NativeConstruct()
{
...
void URPGBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
