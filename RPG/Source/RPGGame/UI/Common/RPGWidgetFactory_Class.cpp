...
#include "RPGWidgetFactory_Class.h"

#include "Blueprint/UserWidget.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGWidgetFactory_Class)

TSubclassOf<UUserWidget> URPGWidgetFactory_Class::FindWidgetClassForData_Implementation(const UObject* Data) const
{
