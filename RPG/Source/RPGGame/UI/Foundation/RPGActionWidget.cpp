...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGActionWidget)

FSlateBrush URPGActionWidget::GetIcon() const
{
...
UEnhancedInputLocalPlayerSubsystem* URPGActionWidget::GetEnhancedInputSubsystem() const
{
