...
#include "RPGControllerDisconnectedScreen.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGControllerDisconnectedScreen)
...
URPGControllerDisconnectedScreen::URPGControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer)
...
void URPGControllerDisconnectedScreen::NativeOnActivated()
{
...
bool URPGControllerDisconnectedScreen::ShouldDisplayChangeUserButton() const
{
...
void URPGControllerDisconnectedScreen::HandleChangeUserClicked()
{
...
void URPGControllerDisconnectedScreen::HandleChangeUserCompleted(const FPlatformUserSelectionCompleteParams& Params)
{
