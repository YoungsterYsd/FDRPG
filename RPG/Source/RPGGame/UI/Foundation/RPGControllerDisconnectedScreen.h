...
#include "RPGControllerDisconnectedScreen.generated.h"
...
class URPGControllerDisconnectedScreen : public UCommonActivatableWidget
{
	GENERATED_BODY()
public:
	URPGControllerDisconnectedScreen(const FObjectInitializer& ObjectInitializer);
