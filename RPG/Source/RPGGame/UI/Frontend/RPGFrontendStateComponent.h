...
#include "RPGFrontendStateComponent.generated.h"
...
UCLASS(Abstract)
class URPGFrontendStateComponent : public UGameStateComponent, public ILoadingProcessInterface
{
	GENERATED_BODY()

public:

	URPGFrontendStateComponent(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
