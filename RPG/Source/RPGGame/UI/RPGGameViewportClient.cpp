...
#include "RPGGameViewportClient.h"

#include "CommonUISettings.h"
#include "ICommonUIModule.h"

#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGGameViewportClient)
...
URPGGameViewportClient::URPGGameViewportClient()
	: Super(FObjectInitializer::Get())
{
}

void URPGGameViewportClient::Init(struct FWorldContext& WorldContext, UGameInstance* OwningGameInstance, bool bCreateNewAudioDevice)
{
