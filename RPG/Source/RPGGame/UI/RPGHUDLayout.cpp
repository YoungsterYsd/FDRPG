...
#include "UI/Foundation/RPGControllerDisconnectedScreen.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGHUDLayout)
...
URPGHUDLayout::URPGHUDLayout(const FObjectInitializer& ObjectInitializer)
...
void URPGHUDLayout::NativeOnInitialized()
{
...
void URPGHUDLayout::NativeDestruct()
{
...
void URPGHUDLayout::HandleEscapeAction()
{
...
void URPGHUDLayout::HandleInputDeviceConnectionChanged(EInputDeviceConnectionState NewConnectionState, FPlatformUserId PlatformUserId, FInputDeviceId InputDeviceId)
{
...
void URPGHUDLayout::HandleInputDevicePairingChanged(FInputDeviceId InputDeviceId, FPlatformUserId NewUserPlatformId, FPlatformUserId OldUserPlatformId)
{
	const FPlatformUserId OwningLocalPlayerId = GetOwningLocalPlayer()->GetPlatformUserId();
...
bool URPGHUDLayout::ShouldPlatformDisplayControllerDisconnectScreen() const
{
...
void URPGHUDLayout::NotifyControllerStateChangeForDisconnectScreen()
{
...
void URPGHUDLayout::ProcessControllerDevicesHavingChangedForDisconnectScreen()
{
	// We should only ever get here if we have bound to the controller state change delegates
	ensure(ShouldPlatformDisplayControllerDisconnectScreen());
...
void URPGHUDLayout::DisplayControllerDisconnectedMenu_Implementation()
{
...
void URPGHUDLayout::HideControllerDisconnectedMenu_Implementation()
{
