...
class UObject;
class URPGControllerDisconnectedScreen;
 ...
 */
UCLASS(Abstract, BlueprintType, Blueprintable, Meta = (DisplayName = "RPG HUD Layout", Category = "RPG|HUD"))
class URPGHUDLayout : public URPGActivatableWidget
{
	GENERATED_BODY()
...
protected:
	...
	*/
	...
	TSubclassOf<URPGControllerDisconnectedScreen> ControllerDisconnectedScreen;
