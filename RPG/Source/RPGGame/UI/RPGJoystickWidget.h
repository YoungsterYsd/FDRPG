...
#include "RPGJoystickWidget.generated.h"
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="RPG Joystick" ))
class URPGJoystickWidget : public URPGSimulatedInputWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API URPGJoystickWidget(const FObjectInitializer& ObjectInitializer);
