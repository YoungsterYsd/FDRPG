...
#include "RPGSettingScreen.generated.h"

class UGameSettingRegistry;
class URPGTabListWidgetBase;
class UObject;

UCLASS(Abstract, meta = (Category = "Settings", DisableNativeTick))
class URPGSettingScreen : public UGameSettingScreen
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<URPGTabListWidgetBase> TopSettingsTabs;
