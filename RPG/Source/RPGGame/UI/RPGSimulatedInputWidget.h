...
#include "RPGSimulatedInputWidget.generated.h"
 ...
 */
UCLASS(MinimalAPI, meta=( DisplayName="RPG Simulated Input Widget" ))
class URPGSimulatedInputWidget : public UCommonUserWidget
{
	GENERATED_BODY()
	
public:
	
	UE_API URPGSimulatedInputWidget(const FObjectInitializer& ObjectInitializer);
