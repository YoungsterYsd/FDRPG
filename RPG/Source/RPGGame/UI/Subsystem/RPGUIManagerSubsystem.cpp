...
void URPGUIManagerSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
	...
	TickHandle = FTSTicker::GetCoreTicker().AddTicker(FTickerDelegate::CreateUObject(this, &URPGUIManagerSubsystem::Tick), 0.0f);
}
...
bool URPGUIManagerSubsystem::Tick(float DeltaTime)
{
...
void URPGUIManagerSubsystem::SyncRootLayoutVisibilityToShowHUD()
{
