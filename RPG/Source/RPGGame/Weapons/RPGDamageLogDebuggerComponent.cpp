...
#include "RPGDamageLogDebuggerComponent.h"
...
void URPGDamageLogDebuggerComponent::BeginPlay()
{
	Super::BeginPlay();
...
void URPGDamageLogDebuggerComponent::TickComponent(float DeltaTime, enum ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void URPGDamageLogDebuggerComponent::OnDamageMessage(FGameplayTag Channel, const FRPGVerbMessage& Payload)
{
