...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RPGRangedWeaponInstance)

UE_DEFINE_GAMEPLAY_TAG_STATIC(TAG_Lyra_Weapon_SteadyAimingCamera, "RPG.Weapon.SteadyAimingCamera");
...
void URPGRangedWeaponInstance::PostLoad()
{
	Super::PostLoad();
...
#if WITH_EDITOR
void URPGRangedWeaponInstance::PostEditChangeProperty(struct FPropertyChangedEvent& PropertyChangedEvent)
{
	Super::PostEditChangeProperty(PropertyChangedEvent);
	UpdateDebugVisualization();
}

void URPGRangedWeaponInstance::UpdateDebugVisualization()
{
...
void URPGRangedWeaponInstance::OnEquipped()
{
	Super::OnEquipped();
...
void URPGRangedWeaponInstance::OnUnequipped()
{
	Super::OnUnequipped();
}

void URPGRangedWeaponInstance::Tick(float DeltaSeconds)
{
	APawn* Pawn = GetPawn();
	check(Pawn != nullptr);
...
void URPGRangedWeaponInstance::ComputeHeatRange(float& MinHeat, float& MaxHeat)
{
	float Min1;
	float Max1;
...
void URPGRangedWeaponInstance::ComputeSpreadRange(float& MinSpread, float& MaxSpread)
{
	HeatToSpreadCurve.GetRichCurveConst()->GetValueRange(/*out*/ MinSpread, /*out*/ MaxSpread);
}

void URPGRangedWeaponInstance::AddSpread()
{
...
bool URPGRangedWeaponInstance::UpdateSpread(float DeltaSeconds)
{
...
bool URPGRangedWeaponInstance::UpdateMultipliers(float DeltaSeconds)
{
