 ...
 */
UCLASS(MinimalAPI)
class URPGWeaponInstance : public URPGEquipmentInstance
{
	GENERATED_BODY()

public:
	UE_API URPGWeaponInstance(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
...
protected:
	...
	FRPGAnimLayerSelectionSet EquippedAnimSet;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category=Animation)
	FRPGAnimLayerSelectionSet UneuippedAnimSet;
