...
#include "RPGWeaponSpawner.generated.h"
...
class URPGWeaponPickupDefinition;
class UObject;
...
class ARPGWeaponSpawner : public AActor
{
	GENERATED_BODY()
	
public:	
	// Sets default values for this actor's properties
	UE_API ARPGWeaponSpawner();
...
protected:
	...
	UPROPERTY(EditInstanceOnly, BlueprintReadOnly, Category = "RPG|WeaponPickup")
	TObjectPtr<URPGWeaponPickupDefinition> WeaponDefinition;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, ReplicatedUsing = OnRep_WeaponAvailability, Category = "RPG|WeaponPickup")
	bool bIsWeaponAvailable;

	//The amount of time between weapon pickup and weapon spawning in seconds
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "RPG|WeaponPickup")
	float CoolDownTime;
	...
	UPROPERTY(BlueprintReadOnly, Transient, Category = "RPG|WeaponPickup")
...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "RPG|WeaponPickup")
	TObjectPtr<UStaticMeshComponent> WeaponMesh;

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "RPG|WeaponPickup")
	...
	UFUNCTION(BlueprintImplementableEvent, Category = "RPG|WeaponPickup")
	UE_API bool GiveWeapon(TSubclassOf<URPGInventoryItemDefinition> WeaponItemClass, APawn* ReceivingPawn);

	UE_API void StartCoolDown();

	UFUNCTION(BlueprintCallable, Category = "RPG|WeaponPickup")
	...
	UFUNCTION(BlueprintNativeEvent, Category = "RPG|WeaponPickup")
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "RPG|WeaponPickup")
	static UE_API int32 GetDefaultStatFromItemDef(const TSubclassOf<URPGInventoryItemDefinition> WeaponItemClass, FGameplayTag StatTag);
};
